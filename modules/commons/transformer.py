...
from modules.commons.layers import LayerNorm, Embedding, ConditionalLayerNorm
...
from modules.commons.mixstyle import MixStyle
    ...
    def __init__(
        ...
        if num_heads > 0:
            if norm == "ln":
                ...
                self.layer_norm1 = ConditionalLayerNorm(c, c)
            elif norm == "mixln":
        ...
        if norm == "ln":
            ...
            self.layer_norm2 = ConditionalLayerNorm(c, c)
        elif norm == "mixln":
