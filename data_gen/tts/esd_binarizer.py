...
class Binarizer:
    ...
    def process_data(self, prefix):
        ...
        for item_id, item in multiprocess_run_tqdm(
            ...
            if item is not None:
                items.append(item)
        print(self.binarization_args["with_spk_embed"])
        ...
        try:
            ...
            if binarization_args["with_align"]:
                ...
                if binarization_args["trim_eos_bos"]:
                    ...
                    # item["wav_flat"] = wav_flat[
                    #     n_bos_frames * hparams["hop_size"] : len(wav)
                    #     - n_eos_frames * hparams["hop_size"]
                    # ]
                    # if item["wav"].shape[-1] != item["wav_flat"].shape[-1]:
                    #     assert print(item_name)
    ...
    def process_audio(cls, wav_fn, res, binarization_args):
        wav2spec_dict = librosa_wav2spec_bigvgan(
            wav_fn,
        ...
        # wav_flat = wav2spec_dict["wav_flat"].astype(np.float16)
